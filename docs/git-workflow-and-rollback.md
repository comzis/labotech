...
- Confirm service health endpoint after deploy: `curl -f http://127.0.0.1:4000/health`
- Confirm stream list endpoint: `curl -f http://127.0.0.1:4000/streams`
...
curl -f http://127.0.0.1:4000/streams
